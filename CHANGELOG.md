...
- Pixiv 与 Civitai 的浏览器操作更接近真人：鼠标沿带抖动的自然轨迹移动并点击，标题、简介和标签逐键输入且节奏有快有慢，连续操作会逐渐放缓、偶尔走神，投稿间隔随机化并偶尔长休息，降低被误判为机器人的概率。
- Pixiv 每个批次投稿前会先像真人一样浏览首页，相邻投稿之间偶尔过渡浏览首页或刚发布的作品页，不再直奔投稿页秒提交。
